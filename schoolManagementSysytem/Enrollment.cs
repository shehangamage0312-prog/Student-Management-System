...
namespace schoolManagementSysytem
{
    public partial class Enrollment : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-3OUQQJJ\SQLEXPRESS;Initial Catalog=schooldb;Integrated Security=True;TrustServerCertificate=True"))
                {
                    ...
                    SqlCommand cnn = new SqlCommand("insert into enroll values(@EId, @StudentName,@Section,@EnrollDate)", con);
                    cnn.Parameters.AddWithValue("@EId", int.Parse(textBox1.Text)); // studentId as integer
                    ...
                    cnn.Parameters.AddWithValue("@EnrollDate", dateTimePicker1.Value); // DateOfBirth as DateTime
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cnn = new SqlCommand("select * from enroll", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-3OUQQJJ\SQLEXPRESS;Initial Catalog=schooldb;Integrated Security=True;TrustServerCertificate=True"))
                {
                    ...
                    // Use parameterized query to avoid SQL injection
                    SqlCommand cnn = new SqlCommand("update enroll set StudentName=@StudentName,Section=@Section,EnrollDate=@EnrollDate where EId=@EId", con);
                    cnn.Parameters.AddWithValue("@EId", int.Parse(textBox1.Text)); // studentId as integer
                    cnn.Parameters.AddWithValue("@StudentName", textBox2.Text); // StudentName as string
                    cnn.Parameters.AddWithValue("@Section", textBox3.Text); // Gender as string
                    cnn.Parameters.AddWithValue("@EnrollDate", dateTimePicker1.Value); // Gender as string
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-3OUQQJJ\SQLEXPRESS;Initial Catalog=schooldb;Integrated Security=True;TrustServerCertificate=True"))
                {
                    ...
                    // Use parameterized query to avoid SQL injection
                    SqlCommand cnn = new SqlCommand("delete enroll where EId=@EId", con);
                    cnn.Parameters.AddWithValue("@EId", int.Parse(textBox1.Text)); // studentId as integer
